...
sealed class EnvVariable {
    sealed class Str(val variable: String, val optional: Boolean = false) :
        EnvVariable() {
        object YahooClientId : Str(System.getenv("YAHOO_CLIENT_ID") ?: "")
        object YahooClientSecret :
            Str(System.getenv("YAHOO_CLIENT_SECRET") ?: "")
        ...
        object YahooGameKey :
            Str(System.getenv("YAHOO_GAME_KEY")?.toLowerCase() ?: "")
        ...
        object DiscordWebhookUrl :
            Str(System.getenv("DISCORD_WEBHOOK_URL") ?: "", true)

        object SlackWebhookUrl :
            Str(System.getenv("SLACK_WEBHOOK_URL") ?: "", true)

        object JdbcDatabaseUrl : Str(System.getenv("JDBC_DATABASE_URL") ?: "")
    }

    sealed class Bool(val variable: Boolean) : EnvVariable() {
        object OptInCloseScore :
            Bool(System.getenv("OPT_IN_CLOSE_SCORE")?.toBoolean() ?: false)
    }
